...
class Pet:
    ...
    def __init__(self, name, hunger = 0, bordom = 0, age = 0.0):
        self.__name= name
        self.hunger = hunger
        self.bordom = bordom
        self.age = age
        self.death_chance = 0.0
        self.alive = True
        Pet.total += 1
    ...
    def talk(self):
        ...
        print("Меня зовут", self.__name, ", мне", str(int(self.age)), "годиков(-а),", "и сейчас я чувствую себя", self.mood)
        self.__pass_time()
    ...
    def __pass_time(self):
        ...
        self.bordom += 1
        self.age += 0.25
        self.death_chance = self.age + float(("0." + str(self.bordom)))*3
        if random.randint(0, 101) < self.death_chance:
            print()
            print()
            print("К сожалению, зверюшка", self.__name, "умерла в возрасте", str(int(self.age)), "годиков.")
            self.alive = False
